...
Revision ID: 7c3882186113
Revises: 
Create Date: 2025-01-15 12:07:57.990275
...
def upgrade() -> None:
    ...
    sa.UniqueConstraint('name', name='unique_attribute_name')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', 'level', name='unique_product_type_name_level')
    )
    ...
    sa.Column('name', sa.String(length=100), nullable=False),
    sa.CheckConstraint('LENGTH(name) > 0', name='seasonal_events_name_length_check'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('name', name='unique_seasonal_events_name')
    )
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_id', 'attribute_value', name='unique_attribute_value_attribute_id')
    )
    ...
    sa.ForeignKeyConstraint(['seasonal_id'], ['seasonal_events.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('product_id', 'product_type_id', name='unique_product_product_type')
    )
    ...
    sa.ForeignKeyConstraint(['product_line_id'], ['product_line.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('attribute_value_id', 'product_line_id', name='unique_attribute_value_product_line')
    )
